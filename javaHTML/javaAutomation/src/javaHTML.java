...
public class javaHTML {
    ...
    public static void main(String[] args) throws IOException { // CsvValidationException {
         ...
         * myObj.nextLine(); fileName1 = myObj.nextLine();
         */
    ...
    public static void fileWriter(String name1, String name2, String name3) { // passes parameters to the method
        ...
        try {
            ...
            // myWriter.write("Files in Java might be tricky, " + name1 + " but it is fun
            // enough!"); //uses the passed parameters
            // myWriter.close();
