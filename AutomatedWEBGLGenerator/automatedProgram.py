...
lbl = Label(window, text="What Would You Like to Name the Web GL File")
...
myoSwitch = Label(window, text="Is the Web GL for a Myocardium or a regular heart? Click Generate if yes, skip if not")

myoSwitch.grid(column=0, row = 5)
...
myoBtn = Button(window, text="Generate", command=myocard)

myoBtn.grid(column=0, row=7)

regular = Label(window, text="If the viewer is for a regular heart, how many objs will the viewer need?")

regular.grid(column=0, row=9)

num = Entry(window,width=30)

num.grid(column=0, row=10)
...
numberBtn = Button(window, text="Generate", command=numberSelect)

numberBtn.grid(column=0, row=11)
